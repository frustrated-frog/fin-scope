...
public class ResearchAgentContextBuilder {
    ...
    private String buildPrompt(ResearchMission mission,
        ...
        prompt.append("研究合同\n")
                ...
                .append("研究类型：").append(safe(mission.getResearchType())).append('\n')
                .append("投研方法：").append(mission.getMethodCodes()).append('\n')
                .append("必需证据：").append(mission.getRequiredEvidence()).append('\n')
                .append("确定性计算：").append(mission.getRequiredCalculations()).append('\n')
                .append("反证检查：").append(mission.getCounterChecks()).append('\n')
                .append("方法完成条件：").append(mission.getCompletionCriteria()).append('\n')
