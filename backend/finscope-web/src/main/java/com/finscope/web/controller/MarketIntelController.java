...
public class MarketIntelController {
    private final MarketIntelCapitalService capital;private final MarketIntelRefreshCoordinator refresh;private final CapitalInterpretationFacade agent;private final CapitalInterpretationRepository interpretations;
    public MarketIntelController(MarketIntelCapitalService capital,MarketIntelRefreshCoordinator refresh,CapitalInterpretationFacade agent,CapitalInterpretationRepository interpretations){this.capital=capital;this.refresh=refresh;this.agent=agent;this.interpretations=interpretations;}
