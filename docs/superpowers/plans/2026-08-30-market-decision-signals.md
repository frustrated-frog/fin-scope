...
- [ ] **Step 3: Implement the v3 Python contract**
...
- [ ] **Step 5: Update the market-data README and commit**
...
- [ ] **Step 1: Write failing Java contract and summary tests**
...
- [ ] **Step 2: Run focused Maven tests and verify RED**
...
- [ ] **Step 3: Implement domain models, strict parser, and summaries**
...
- [ ] **Step 4: Run focused Maven tests and verify GREEN**
...
- [ ] **Step 1: Write failing trail tests in Python**
...
- [ ] **Step 2: Run Python sector tests and verify RED**
...
- [ ] **Step 3: Implement deterministic cross-sectional trails**
...
- [ ] **Step 4: Write and verify failing Java trail tests**
...
- [ ] **Step 5: Implement Java trail mapping and verify GREEN**
...
- [ ] **Step 3: Implement responsive panels and SVG trails**
...
- [ ] **Step 2: Run all backend tests with JDK 21**
...
- [ ] **Step 4: Inspect the real local API sample**
...
- [ ] **Step 5: Perform project-rule self-review**
