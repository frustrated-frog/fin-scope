...
beforeEach(() => {
  vi.stubGlobal('fetch', vi.fn().mockResolvedValue({
    ok: true,
    status: 200,
    text: async () => JSON.stringify({ success: true, code: 'SUCCESS', message: 'success', traceId: 'trace', timestamp: '2026-08-15T00:00:00Z', data: [{ id: 1, theme: '科技供应链', question: '美国是否会在今年进一步扩大 AI 芯片出口限制？', marketUrl: 'https://polymarket.com', probability: 62, change1h: 4.2, change24h: 9.4, volume: 1284000, openInterest: 482000, spread: 2, endDate: '2026-12-31', observation: '观察限制范围、具体产品与美国商务部正式文件。', status: 'SIGNAL', dataStatus: 'LIVE', observedAt: '刚刚', lastRefreshAt: '刚刚', priceHistory: [{ observedAt: '09:00', probability: 58 }, { observedAt: '09:05', probability: 62 }] }] })
  }));
});
...
test('opens a detail view with multiple observation windows', async () => {
  ...
  fireEvent.click(screen.getByRole('button', { name: /查看变化详情/ }));
